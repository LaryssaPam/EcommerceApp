            ...
            <div class="mt-6">
              ...
              <div class="mt-6 flex justify-center text-center">
                <form action="{{route('cart.clear')}}" method="post">
                    ...
                    <button type="submit" class="flex items-center justify-center rounded-md border border-transparent bg-red-600 px-6 py-3 text-base font-medium text-white shadow-xs hover:bg-amber-700">Vider le panier</button>
                </form>
            </div> 
