...
<div class="flex h-full flex-col overflow-y-auto bg-white shadow-xl">
                    ...
                    <div class="ml-4 flex flex-1 flex-col">
                      ...
                      <div class="flex flex-1 items-end justify-between text-sm">
                        ...
                        <div class="flex"> 
                          ...
                          <button type="submit" class="font-medium text-indigo-700 hover:text-indigo-500">Remove</button>
                          </form>
                        </div>
                      </div>
                    </div>
          ...
          <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
            ...
            <div class="mt-6">
             ...
             <div class="mt-6">
              <button type="submit" class="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-xs hover:bg-indigo-700">Vider le panier</a>
